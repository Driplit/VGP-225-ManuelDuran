...
public class PlayerController : MonoBehaviour, ThirdPersonInputs.IOverworldActions
{
    ...
    [SerializeField] private float initSpeed = 0.3f;
    [SerializeField] private float maxSpeed = 0.5f;
    [SerializeField] public float SpeedModifire;
    [SerializeField] private float moveAccel = 0.02f;
    ...
    void Update()
    {
        ...
        anim.SetBool("AttackHeld", attackHeld);
    ...
    {
        anim.SetTrigger("Hit"); // Ensure there's a "Hit" trigger in your Animator
    }
